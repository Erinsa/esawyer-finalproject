  ...
  render() {
    ...
    return (
      ...
      <article className = "HomePage">
        ...
        <a className = "other_link" href="#/menupage"><button className='menu_button' aria-label='Return to menu button'><h1 className = "menu_button_text">Moji Match</h1></button></a>
